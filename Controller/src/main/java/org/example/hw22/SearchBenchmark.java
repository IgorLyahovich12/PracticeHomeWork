...
public class SearchBenchmark {
    ...
    public static void runBenchmark(int[] array, int target) {
        long linearSearchTime = measureAndPrintTime("Linear Search", SearchBenchmark::linearSearch, array, target);
        long binarySearchTime = measureAndPrintTime("Binary Search", SearchBenchmark::binarySearch, array, target);
        long quickSearchTime = measureAndPrintTime("Quick Search", (arr, t) -> quickSearchRecursive(arr, t, 0, arr.length - 1), array, target);
    ...
    private static long measureAndPrintTime(String algorithmName, SearchAlgorithm algorithm, int[] array, int target) {
