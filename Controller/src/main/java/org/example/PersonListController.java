...
public class PersonListController {
    ...
    static void filterAndRemoveByAge(HashMap<String, Person> personMap, int thresholdAge) {
    ...
    static String findKeyByName(HashMap<String, Person> personMap, String name) {
